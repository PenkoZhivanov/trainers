...
<div class="container1"  style="margin:auto !important;">
    <div class="main" style="margin: auto; width: 600px !important;">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox"  name="wotkwithgorups" id="wotkwithgorups"> 
                        <span class="chkboxes" onclick="wotkwithgorups.checked = !wotkwithgorups.checked;">Групи</span><br>
                        <input type="checkbox"  name="wotkwithperson" id="wotkwithperson"> 
                        <span class="chkboxes" onclick="wotkwithperson.checked = !wotkwithperson.checked;">Индивидуално</span>
